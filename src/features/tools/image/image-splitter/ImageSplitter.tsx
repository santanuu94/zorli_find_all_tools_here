...
export const ImageSplitter: React.FC<ToolComponentProps> = () => (
  <ToolWorkspace title="Image Splitter & Slicer">
    <div className="border-2 border-dashed border-slate-300 dark:border-white/20 rounded-2xl p-10 md:p-14 flex flex-col items-center justify-center text-center bg-slate-50/50 dark:bg-white/5">
      ...
      <h3 className="text-lg sm:text-xl font-bold font-display text-slate-900 dark:text-white mb-2">
        Split image into equal tiles
      </h3>
      <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 max-w-md mb-6">
        Divide your graphic into rows and columns for panoramic slides or social media carousels.
      </p>
      <button className="px-6 py-3 rounded-full bg-rose-600 hover:bg-rose-500 text-white text-sm font-semibold transition-all shadow-md cursor-pointer">
        Select Graphic
      </button>
    </div>
  </ToolWorkspace>
